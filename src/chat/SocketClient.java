				...
				while(stop == false) {
					...
					switch(command) {
						...
						case "checkLogin":
							...
							chatServer.checkIdPass(this,uid, pwd);
							stop = true;
							break;
						case "joinMem":
							String joinId = jsonObject.getString("Uid");
							String joinPw = jsonObject.getString("Pwd");
							String joinName = jsonObject.getString("Name");
							String joinGender = jsonObject.getString("Gender");
							String joinPhone = jsonObject.getString("Phone");
							String joinEmail = jsonObject.getString("Email");
							chatServer.registerMember(jsonObject);
							
							//chatServer.registerMember(joinId, joinPw, joinName, joinGender, joinPhone, joinEmail);
							//chatServer.registerMember(jsonObject);
							break;
						case "createRoom":
							curRoomName = jsonObject.getString("roomName");
